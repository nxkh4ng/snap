...
func printUsage() {
	...
	fmt.Fprintf(os.Stderr, "  snap [command] [flags]\n\n")
	fmt.Fprintf(os.Stderr, "Commands:\n")
	fmt.Fprintf(os.Stderr, "  init               initialize config\n\n")
	fmt.Fprintf(os.Stderr, "  init flags:\n")
	fmt.Fprintf(os.Stderr, "    (no flag)        create local config at .snap.json next to .git\n\n")
	fmt.Fprintf(os.Stderr, "    -g, --global     create global config at ~/.config/snap/config.json\n")
	...
	fmt.Fprintf(os.Stderr, "  snap init\n")
	fmt.Fprintf(os.Stderr, "  snap init --global\n")
}
